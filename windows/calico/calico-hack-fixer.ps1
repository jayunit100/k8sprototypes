### This is a hacked up  version of the calico installer which is defaulted to work on TKG.... i.e. it copies
### /etc/kubernetes/kubelet.conf over as the configuration for the kubeconfig. IT WILL FAIL but that is ok
### Only goal here is ... to create the HNS network... 
